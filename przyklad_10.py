...
class Vector2D:
    ...
    def __eq__(self, other):
        ...
        try:
            ox, oy = other  # duck-typing: próbujemy rozpakować RHS
        except Exception:
    ...
    def __hash__(self):
        # hash musi być spójny z __eq__ oraz NIE MOŻE SIĘ ZMIENIĆ
        # po umieszczeniu obiektu w zbiorze lub jako klucz dict
...
if __name__ == '__main__':
    ...
    s = set()
    print(s)
    s.add(v1)                 # UWAGA: po dodaniu obiektu do set — NIE wolno zmieniać pól
    print(s)
    print(f'{hash(v1) = }')
